...
define([
    ...
    predixApp.controller('MainCtrl', ['$scope', '$rootScope', 'PredixUserService', function ($scope, $rootScope, predixUserService) {
        ...
        window.App = $rootScope.App = {
            ...
            session: {},
            tabs: [
              {icon: 'fa-tachometer', state: 'dashboards', label: 'Dashboard'},
              {icon: 'fa-tachometer', state: 'dashboards-es', label: 'Raspberry Edwin'},
              {icon: 'fa-tachometer', state: 'dashboards-gb', label: 'Edison George'},
              {icon: 'fa-users', state: 'about', label: 'About us'}
            ]
        };
